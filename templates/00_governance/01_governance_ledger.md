...
**APPLIES:** required (stub at P0; harden at P5)

## Purpose

Rules for changing the world rules. Versioning, owners, sign-off protocol.

## Upstream / Downstream

- **Upstream:** none
- **Downstream:** all `world/` docs; project `inherits_canon`

## Theory

Treatise: `Operational Protocol: How to Use This Folder`; `The Golden Rule of Maintenance`. Continuity parallel: Story Group / Holocron.
...
> World type: brand. Dial: soft. Atmospheric product myth with three hard material bans. Owners: A. Okonkwo (manifesto/lore), J. Park (visual), M. Reyes (verbal). CANON_VERSION 0.3 after palette lock. MAJOR changes require Okonkwo + Park.
...
- [ ] World type and dial recorded
- [ ] Owners named for manifesto and lore
- [ ] Change protocol actionable (who approves what)
- [ ] CANON_VERSION present
- [ ] Sign-off matrix exists (may be empty at stub)
